        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", "\n            <h1>Welcome to my first SPA</h1>\n            <p>In order for the website to show you your location, please allow the website to see your location</p>\n            <p>\n                <a href=\"/location\" data-link><button>Location</button></a>\n            </p>\n        ");
